...
private val UI_STRINGS =
    listOf(
        ...
        "hex_hint" to R.string.heatmap_ui_hex_hint,
        "wallpaper_colors" to R.string.heatmap_ui_wallpaper_colors,
        "basic_colors" to R.string.heatmap_ui_basic_colors,
        "section_curve" to R.string.heatmap_ui_section_curve,
        "section_shape" to R.string.heatmap_ui_section_shape,
        "straight" to R.string.heatmap_ui_straight,
        "auto_max" to R.string.heatmap_ui_auto_max,
        "corner" to R.string.heatmap_ui_corner,
        "gap" to R.string.heatmap_ui_gap,
